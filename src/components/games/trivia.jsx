...
export default function Trivia() {
  ...
  return q.options.map((opt, idx) => (
    ...
    >
      <input
        ...
        onChange={() => {
          if (userAnswers[q.id] === "Pregunta no respondida" || timeLeft === 0) return;
        ...
        className="mr-2 accent-indigo-600"
        disabled={userAnswers[q.id] === "Pregunta no respondida" || timeLeft === 0}
      />
      {opt}
    </label>
  ));
  ...
  return (
    <div className="max-w-xl mx-auto p-6 bg-white rounded-xl shadow space-y-4">
      ...
      <div className="bg-gray-50 rounded-lg p-4 shadow-inner h-[300px] overflow-y-auto">
